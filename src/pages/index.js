...
const IndexPage = () => (
  <div className='container'>
    ...
    <p className='section__header'>Skills:</p>

    <section>
      <p>JavaScript (React, Redux, Angular.js, Node.js, Webpack, Gulp), HTML5, Handlebars, Pug/Jade, CSS, SCSS, Stylus, LESS, PostCSS. Some experience with: Java, AEM, PHP, Wordpress, Drupal.</p>
    </section>
